...
import (
	...
	entity "github.com/Karzoug/innopolis-auth-go/internal/auth/entity"
...
func (m *MockTokenRepository) Delete(key string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Delete", key)
}

// Delete indicates an expected call of Delete.
func (mr *MockTokenRepositoryMockRecorder) Delete(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockTokenRepository)(nil).Delete), key)
}

// Get mocks base method.
func (m *MockTokenRepository) Get(key string) (string, bool) {
	m.ctrl.T.Helper()
...
func (mr *MockTokenRepositoryMockRecorder) Get(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockTokenRepository)(nil).Get), key)
}

// Set mocks base method.
func (m *MockTokenRepository) Set(key, value string, duration time.Duration) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Set", key, value, duration)
}

// Set indicates an expected call of Set.
func (mr *MockTokenRepositoryMockRecorder) Set(key, value, duration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockTokenRepository)(nil).Set), key, value, duration)
}
...
// RefreshExpiresDuration mocks base method.
func (m *MockJWTManager) RefreshExpiresDuration() time.Duration {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RefreshExpiresDuration")
	ret0, _ := ret[0].(time.Duration)
	return ret0
}

// RefreshExpiresDuration indicates an expected call of RefreshExpiresDuration.
func (mr *MockJWTManagerMockRecorder) RefreshExpiresDuration() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RefreshExpiresDuration", reflect.TypeOf((*MockJWTManager)(nil).RefreshExpiresDuration))
}
