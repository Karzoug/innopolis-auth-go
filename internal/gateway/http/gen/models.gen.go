...
// RefreshAccessTokenRequest defines model for RefreshAccessTokenRequest.
type RefreshAccessTokenRequest struct {
	// RefreshToken JWT refresh token of the existing user
	RefreshToken string `json:"refreshToken"`
}
...
type PostRefreshJSONRequestBody = RefreshAccessTokenRequest
